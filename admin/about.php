...
require_once __DIR__ . '/../core/modules/modPriseo.class.php';

// Global variables definitions
global $db, $langs, $user;

// Translations
$langs->loadLangs(['errors', 'admin', 'priseo@priseo']);

// Initialize technical objects
$modPriseo = new modPriseo($db);
...
print dol_get_fiche_head($head, 'about', $title, -1, 'priseo_color@priseo');

print $modPriseo->getDescLong();
