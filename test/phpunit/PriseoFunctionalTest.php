...
/**
 * \file    test/phpunit/PriseoFunctionalTest.php
 * \ingroup priseo
 ...
 * @package Testpriseo
 */
class PriseoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/priseo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('priseo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/priseo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('priseo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('priseowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPriseo_PriseoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPriseo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
